...
export default function TodoInput({ onAdd }: TodoInputProps) {
  ...
  return (
    <div className="p-4 space-y-4 w-full max-w-sm mx-auto border rounded-lg bg-white shadow">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <button
          type="submit"
          className="w-full py-2 text-md font-bold bg-blue-500 text-white rounded hover:bg-blue-600 disabled:opacity-50"
